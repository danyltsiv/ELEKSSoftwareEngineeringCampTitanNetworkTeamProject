...
namespace WebApiTier.ChatServiceReference {
    ...
    public interface IChatService {
        ...
        WebApiTier.ChatServiceReference.UserInfoDTO[] GetAllUsersFromChat(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/GetAllUsersFromChat", ReplyAction="http://tempuri.org/IChatService/GetAllUsersFromChatResponse")]
        System.Threading.Tasks.Task<WebApiTier.ChatServiceReference.UserInfoDTO[]> GetAllUsersFromChatAsync(int id);
        ...
        WebApiTier.ChatServiceReference.MessageDTO[] GetAllMessagesFromChat(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/GetAllMessagesFromChat", ReplyAction="http://tempuri.org/IChatService/GetAllMessagesFromChatResponse")]
        System.Threading.Tasks.Task<WebApiTier.ChatServiceReference.MessageDTO[]> GetAllMessagesFromChatAsync(int id);
        ...
        WebApiTier.ChatServiceReference.ChatDTO GetChatById(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/GetChatById", ReplyAction="http://tempuri.org/IChatService/GetChatByIdResponse")]
        System.Threading.Tasks.Task<WebApiTier.ChatServiceReference.ChatDTO> GetChatByIdAsync(int id);
        ...
        int AddChat(WebApiTier.ChatServiceReference.ChatDTO chat);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/AddChat", ReplyAction="http://tempuri.org/IChatService/AddChatResponse")]
        System.Threading.Tasks.Task<int> AddChatAsync(WebApiTier.ChatServiceReference.ChatDTO chat);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/AddUser", ReplyAction="http://tempuri.org/IChatService/AddUserResponse")]
        System.Threading.Tasks.Task<bool> AddUserAsync(int id, int userId);
        ...
        int AddMessage(int id, WebApiTier.ChatServiceReference.MessageDTO message);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/AddMessage", ReplyAction="http://tempuri.org/IChatService/AddMessageResponse")]
        System.Threading.Tasks.Task<int> AddMessageAsync(int id, WebApiTier.ChatServiceReference.MessageDTO message);
        ...
        bool UpdateChat(WebApiTier.ChatServiceReference.ChatDTO chat);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/UpdateChat", ReplyAction="http://tempuri.org/IChatService/UpdateChatResponse")]
        System.Threading.Tasks.Task<bool> UpdateChatAsync(WebApiTier.ChatServiceReference.ChatDTO chat);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IChatServiceChannel : WebApiTier.ChatServiceReference.IChatService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ChatServiceClient : System.ServiceModel.ClientBase<WebApiTier.ChatServiceReference.IChatService>, WebApiTier.ChatServiceReference.IChatService {
        ...
        public WebApiTier.ChatServiceReference.UserInfoDTO[] GetAllUsersFromChat(int id) {
            return base.Channel.GetAllUsersFromChat(id);
        }
        
        public System.Threading.Tasks.Task<WebApiTier.ChatServiceReference.UserInfoDTO[]> GetAllUsersFromChatAsync(int id) {
            return base.Channel.GetAllUsersFromChatAsync(id);
        }
        
        public WebApiTier.ChatServiceReference.MessageDTO[] GetAllMessagesFromChat(int id) {
            return base.Channel.GetAllMessagesFromChat(id);
        }
        
        public System.Threading.Tasks.Task<WebApiTier.ChatServiceReference.MessageDTO[]> GetAllMessagesFromChatAsync(int id) {
            return base.Channel.GetAllMessagesFromChatAsync(id);
        }
        
        public WebApiTier.ChatServiceReference.ChatDTO GetChatById(int id) {
            return base.Channel.GetChatById(id);
        }
        
        public System.Threading.Tasks.Task<WebApiTier.ChatServiceReference.ChatDTO> GetChatByIdAsync(int id) {
            return base.Channel.GetChatByIdAsync(id);
        }
        
        public int AddChat(WebApiTier.ChatServiceReference.ChatDTO chat) {
            return base.Channel.AddChat(chat);
        }
        
        public System.Threading.Tasks.Task<int> AddChatAsync(WebApiTier.ChatServiceReference.ChatDTO chat) {
            return base.Channel.AddChatAsync(chat);
        }
        
        public bool AddUser(int id, int userId) {
            return base.Channel.AddUser(id, userId);
        }
        
        public System.Threading.Tasks.Task<bool> AddUserAsync(int id, int userId) {
            return base.Channel.AddUserAsync(id, userId);
        }
        
        public int AddMessage(int id, WebApiTier.ChatServiceReference.MessageDTO message) {
            return base.Channel.AddMessage(id, message);
        }
        
        public System.Threading.Tasks.Task<int> AddMessageAsync(int id, WebApiTier.ChatServiceReference.MessageDTO message) {
            return base.Channel.AddMessageAsync(id, message);
        }
        
        public bool UpdateChat(WebApiTier.ChatServiceReference.ChatDTO chat) {
            return base.Channel.UpdateChat(chat);
        }
        
        public System.Threading.Tasks.Task<bool> UpdateChatAsync(WebApiTier.ChatServiceReference.ChatDTO chat) {

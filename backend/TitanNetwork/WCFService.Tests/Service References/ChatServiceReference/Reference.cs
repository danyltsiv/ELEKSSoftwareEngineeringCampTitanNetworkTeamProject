...
namespace WCFService.Tests.ChatServiceReference {
    ...
    public interface IChatService {
        ...
        WCFService.Tests.ChatServiceReference.UserInfoDTO[] GetAllUsersFromChat(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/GetAllUsersFromChat", ReplyAction="http://tempuri.org/IChatService/GetAllUsersFromChatResponse")]
        System.Threading.Tasks.Task<WCFService.Tests.ChatServiceReference.UserInfoDTO[]> GetAllUsersFromChatAsync(int id);
        ...
        WCFService.Tests.ChatServiceReference.MessageDTO[] GetAllMessagesFromChat(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/GetAllMessagesFromChat", ReplyAction="http://tempuri.org/IChatService/GetAllMessagesFromChatResponse")]
        System.Threading.Tasks.Task<WCFService.Tests.ChatServiceReference.MessageDTO[]> GetAllMessagesFromChatAsync(int id);
        ...
        WCFService.Tests.ChatServiceReference.ChatDTO GetChatById(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/GetChatById", ReplyAction="http://tempuri.org/IChatService/GetChatByIdResponse")]
        System.Threading.Tasks.Task<WCFService.Tests.ChatServiceReference.ChatDTO> GetChatByIdAsync(int id);
        ...
        void AddChat(WCFService.Tests.ChatServiceReference.ChatDTO chat);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/AddChat", ReplyAction="http://tempuri.org/IChatService/AddChatResponse")]
        System.Threading.Tasks.Task AddChatAsync(WCFService.Tests.ChatServiceReference.ChatDTO chat);
        ...
        void AddUser(int id, WCFService.Tests.ChatServiceReference.UserInfoDTO user);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/AddUser", ReplyAction="http://tempuri.org/IChatService/AddUserResponse")]
        System.Threading.Tasks.Task AddUserAsync(int id, WCFService.Tests.ChatServiceReference.UserInfoDTO user);
        ...
        void AddMessage(int id, WCFService.Tests.ChatServiceReference.MessageDTO message);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/AddMessage", ReplyAction="http://tempuri.org/IChatService/AddMessageResponse")]
        System.Threading.Tasks.Task AddMessageAsync(int id, WCFService.Tests.ChatServiceReference.MessageDTO message);
        ...
        void UpdateChat(WCFService.Tests.ChatServiceReference.ChatDTO chat);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IChatService/UpdateChat", ReplyAction="http://tempuri.org/IChatService/UpdateChatResponse")]
        System.Threading.Tasks.Task UpdateChatAsync(WCFService.Tests.ChatServiceReference.ChatDTO chat);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IChatServiceChannel : WCFService.Tests.ChatServiceReference.IChatService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ChatServiceClient : System.ServiceModel.ClientBase<WCFService.Tests.ChatServiceReference.IChatService>, WCFService.Tests.ChatServiceReference.IChatService {
        ...
        public WCFService.Tests.ChatServiceReference.UserInfoDTO[] GetAllUsersFromChat(int id) {
            return base.Channel.GetAllUsersFromChat(id);
        }
        
        public System.Threading.Tasks.Task<WCFService.Tests.ChatServiceReference.UserInfoDTO[]> GetAllUsersFromChatAsync(int id) {
            return base.Channel.GetAllUsersFromChatAsync(id);
        }
        
        public WCFService.Tests.ChatServiceReference.MessageDTO[] GetAllMessagesFromChat(int id) {
            return base.Channel.GetAllMessagesFromChat(id);
        }
        
        public System.Threading.Tasks.Task<WCFService.Tests.ChatServiceReference.MessageDTO[]> GetAllMessagesFromChatAsync(int id) {
            return base.Channel.GetAllMessagesFromChatAsync(id);
        }
        
        public WCFService.Tests.ChatServiceReference.ChatDTO GetChatById(int id) {
            return base.Channel.GetChatById(id);
        }
        
        public System.Threading.Tasks.Task<WCFService.Tests.ChatServiceReference.ChatDTO> GetChatByIdAsync(int id) {
            return base.Channel.GetChatByIdAsync(id);
        }
        
        public void AddChat(WCFService.Tests.ChatServiceReference.ChatDTO chat) {
            base.Channel.AddChat(chat);
        }
        
        public System.Threading.Tasks.Task AddChatAsync(WCFService.Tests.ChatServiceReference.ChatDTO chat) {
            return base.Channel.AddChatAsync(chat);
        }
        
        public void AddUser(int id, WCFService.Tests.ChatServiceReference.UserInfoDTO user) {
            base.Channel.AddUser(id, user);
        }
        
        public System.Threading.Tasks.Task AddUserAsync(int id, WCFService.Tests.ChatServiceReference.UserInfoDTO user) {
            return base.Channel.AddUserAsync(id, user);
        }
        
        public void AddMessage(int id, WCFService.Tests.ChatServiceReference.MessageDTO message) {
            base.Channel.AddMessage(id, message);
        }
        
        public System.Threading.Tasks.Task AddMessageAsync(int id, WCFService.Tests.ChatServiceReference.MessageDTO message) {
            return base.Channel.AddMessageAsync(id, message);
        }
        
        public void UpdateChat(WCFService.Tests.ChatServiceReference.ChatDTO chat) {
            base.Channel.UpdateChat(chat);
        }
        
        public System.Threading.Tasks.Task UpdateChatAsync(WCFService.Tests.ChatServiceReference.ChatDTO chat) {
